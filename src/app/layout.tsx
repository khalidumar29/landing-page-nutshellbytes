...
export const metadata: Metadata = {
  title:
    "Nutshell Bytes - Premium Web Development Agency | Custom Software Solutions 2025",
  description:
  ...
  openGraph: {
    title:
      "Nutshell Bytes - Premium Web Development Agency | 500+ Projects Delivered",
    description:
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              alternateName: [
                "Nutshell Bytes Digital Agency",
                "Nutshell Bytes Web Development",
              ],
              url: "https://nutshellbytes.com",
              logo: {
                "@type": "ImageObject",
                url: "https://nutshellbytes.com/logo.png",
                width: 400,
                height: 400,
              },
              image: "https://nutshellbytes.com/og-image.jpg",
              description:
                "Premium web development and digital solutions agency. We transform businesses through custom web applications, SaaS platforms, and intelligent automation. Trusted by startups to enterprise clients worldwide.",
              foundingDate: "2020",
                ...
                itemListElement: [
                  {
                    ...
                    itemOffered: {
                      ...
                      description:
                        "Bespoke web applications built with modern technologies",
                      provider: {
                        "@id": "https://nutshellbytes.com/#organization",
                      },
                    },
                  },
                  {
                    ...
                    itemOffered: {
                      ...
                      description:
                        "Scalable software-as-a-service solutions for businesses",
                      provider: {
                        "@id": "https://nutshellbytes.com/#organization",
                      },
                    },
                  },
                  {
                    ...
                    itemOffered: {
                      ...
                      description:
                        "Custom workflow automation and business process optimization",
                      provider: {
                        "@id": "https://nutshellbytes.com/#organization",
                      },
                    },
                  ...
                  },
                  {
                    ...
                    itemOffered: {
                      ...
                      description:
                        "User-centered design and interactive prototypes",
                      provider: {
                        "@id": "https://nutshellbytes.com/#organization",
                      },
                    },
              ...
              review: [
                {
                  ...
                  reviewBody:
                    "Exceptional web development services. Nutshell Bytes transformed our business with a beautiful, fast website that converts visitors into customers.",
                },
              ],
              potentialAction: {
                "@type": "ContactAction",
